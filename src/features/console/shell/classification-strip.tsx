...
export function ClassificationStrip(): React.JSX.Element {
  return (
    <header className="hidden min-h-[var(--console-class-height)] shrink-0 flex-wrap items-center justify-between gap-x-3 gap-y-1 border-b border-[var(--console-hairline)] bg-[var(--console-strip)] px-3 py-1 sm:px-5 lg:flex">
